...
f = Heat_Map(mod_name='uav_beijing', bs_type = 'Terrestrial',
             npts=100, nsect = 3,
...
rx_matrix2= f.plot_heat_map(bs_type="Terrestrial", tilt_angle= -12, get_link_state=True, annot=False, nsect =3,
