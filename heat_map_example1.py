...
f = Heat_Map(mod_name='uav_beijing', bs_type = 'Aerial',
             ...
             vertical_axis_of_net = np.linspace(-100, 100,10),  plane_shift=10)
...
f.plot_heat_map(bs_type="Aerial", tilt_angle= 45, get_link_state= True, annot= False, nsect =3, plane_type= 'xz', bs_height=10)
