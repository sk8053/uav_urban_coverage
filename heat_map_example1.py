...
f.plane_type = 'xy'
f.net_work_area_hori=np.linspace(-100, 800, 11)
f.net_work_area_verti = np.linspace(-100, 800, 11)
f.cdf_prob = 0.1 # take meadian value
#f.get_association(aerial_height=10, tilt_angel_t=-22, tilt_angle_a=45, plane_shift=30)
f.plot_heat_map(bs_type="Terrestrial", tilt_angle= -22, get_link_state= True, annot= False, nsect =1, plane_type= 'xy')
